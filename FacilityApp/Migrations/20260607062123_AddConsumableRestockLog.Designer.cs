...
namespace FacilityApp.Migrations
{
    ...
    [Migration("20260607062123_AddConsumableRestockLog")]
    partial class AddConsumableRestockLog
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("FacilityApp.Data.Models.AppRole", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("FacilityApp.Data.Models.ConsumableIssuance", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("consumable_issuances", (string)null);
                });

            modelBuilder.Entity("FacilityApp.Data.Models.ConsumableRestockLog", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.Property<string>("RestockedById")
                        .IsRequired()
                        .HasColumnType("text");
                    ...
                    b.HasIndex("RestockedById");

                    b.HasIndex("TenantId");

                    b.ToTable("consumable_restock_logs", (string)null);
                });

            modelBuilder.Entity("FacilityApp.Data.Models.ConsumableType", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("consumable_types", (string)null);
                });

            modelBuilder.Entity("FacilityApp.Data.Models.Document", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("FacilityApp.Data.Models.EmployeeProfile", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("FacilityApp.Data.Models.IncidentReport", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("FacilityApp.Data.Models.Meter", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.Property<Guid?>("PreviousMeterId")
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("FacilityApp.Data.Models.MeterAlert", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("meter_alerts", (string)null);
                });

            modelBuilder.Entity("FacilityApp.Data.Models.MeterReading", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("FacilityApp.Data.Models.OwnerProfile", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.Property<bool>("IsAbsenteeOwner")
                        .HasColumnType("boolean");

                    b.Property<string>("KraPin")
                        .HasColumnType("text");

                    b.Property<string>("LevyPaymentMethod")
                        .HasColumnType("text");

                    b.Property<string>("ManagingAgentContact")
                        .HasColumnType("text");

                    b.Property<string>("ManagingAgentName")
                        .HasColumnType("text");

                    b.Property<Guid>("TenantId")
                        .HasColumnType("uuid");

                    b.Property<string>("TitleDeedRef")
                        .HasColumnType("text");
            ...
            modelBuilder.Entity("FacilityApp.Data.Models.Payment", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.Property<string>("MpesaReceiptNo")
                        .HasColumnType("text");
            ...
            modelBuilder.Entity("FacilityApp.Data.Models.PlatformAnnouncement", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("FacilityApp.Data.Models.PrepaidToken", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.Property<decimal?>("UnitsLoaded")
                        .HasColumnType("numeric");
                    ...
                    b.ToTable("prepaid_tokens", (string)null);
                });

            modelBuilder.Entity("FacilityApp.Data.Models.RefreshToken", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("FacilityApp.Data.Models.ResidentProfile", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("FacilityApp.Data.Models.RolePermission", b =>
                {
            ...
            modelBuilder.Entity("FacilityApp.Data.Models.Unit", b =>
                {
                    ...
                    b.Property<decimal?>("MonthlyLevy")
                        .HasColumnType("numeric");
            ...
            modelBuilder.Entity("FacilityApp.Data.Models.UnitType", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.Property<int?>("DefaultBathrooms")
                        .HasColumnType("integer");

                    b.Property<int?>("DefaultBedrooms")
                        .HasColumnType("integer");

                    b.Property<decimal?>("DefaultMonthlyLevy")
                        .HasColumnType("numeric");
            ...
            modelBuilder.Entity("FacilityApp.Data.Models.UserUnit", b =>
                {
                    ...
                    b.Property<string>("GuarantorIdNumber")
                        .HasColumnType("text");
                    ...
                    b.Property<string>("RentalAgreementRef")
                        .HasColumnType("text");
            ...
            modelBuilder.Entity("FacilityApp.Data.Models.ConsumableIssuance", b =>
                {
                    b.HasOne("FacilityApp.Data.Models.ConsumableType", "ConsumableType")
                        .WithMany("Issuances")
            ...
            modelBuilder.Entity("FacilityApp.Data.Models.ConsumableRestockLog", b =>
                {
                    ...
                    b.HasOne("FacilityApp.Data.Models.ApplicationUser", "RestockedBy")
                        .WithMany()
                        .HasForeignKey("RestockedById")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();
            ...
            modelBuilder.Entity("FacilityApp.Data.Models.Document", b =>
                {
                    ...
                    b.HasOne("FacilityApp.Data.Models.ApplicationUser", "UploadedBy")
                        .WithMany()
            ...
            modelBuilder.Entity("FacilityApp.Data.Models.EmployeeProfile", b =>
                {
                    ...
                    b.HasOne("FacilityApp.Data.Models.ApplicationUser", "User")
                        .WithOne()
                        .HasForeignKey("FacilityApp.Data.Models.EmployeeProfile", "UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("FacilityApp.Data.Models.IncidentReport", b =>
                {
                    b.HasOne("FacilityApp.Data.Models.ApplicationUser", "ReportedBy")
                        .WithMany()
                        .HasForeignKey("ReportedById")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("FacilityApp.Data.Models.ApplicationUser", "ResolvedBy")
                        .WithMany()
            ...
            modelBuilder.Entity("FacilityApp.Data.Models.Meter", b =>
                {
                    b.HasOne("FacilityApp.Data.Models.Meter", "PreviousMeter")
                        .WithOne("ReplacedByMeter")
                        .HasForeignKey("FacilityApp.Data.Models.Meter", "PreviousMeterId")
                        .OnDelete(DeleteBehavior.SetNull);
            ...
            modelBuilder.Entity("FacilityApp.Data.Models.MeterAlert", b =>
                {
                    b.HasOne("FacilityApp.Data.Models.ApplicationUser", "AcknowledgedBy")
                        .WithMany()
                        .HasForeignKey("AcknowledgedByUserId")
                        .OnDelete(DeleteBehavior.SetNull);

                    b.HasOne("FacilityApp.Data.Models.Meter", "Meter")
                        .WithMany("Alerts")
            ...
            modelBuilder.Entity("FacilityApp.Data.Models.MeterReading", b =>
                {
                    ...
                    b.HasOne("FacilityApp.Data.Models.ApplicationUser", "ReadBy")
                        .WithMany()
            ...
            modelBuilder.Entity("FacilityApp.Data.Models.OwnerProfile", b =>
                {
                    ...
                    b.HasOne("FacilityApp.Data.Models.ApplicationUser", "User")
                        ...
                        .HasForeignKey("FacilityApp.Data.Models.OwnerProfile", "UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("FacilityApp.Data.Models.Payment", b =>
                {
                    b.HasOne("FacilityApp.Data.Models.ApplicationUser", "RecordedBy")
                        .WithMany()
            ...
            modelBuilder.Entity("FacilityApp.Data.Models.PrepaidToken", b =>
                {
                    b.HasOne("FacilityApp.Data.Models.Meter", "Meter")
                        .WithMany("PrepaidTokens")
                        .HasForeignKey("MeterId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("FacilityApp.Data.Models.ApplicationUser", "PurchasedBy")
                        .WithMany()
            ...
            modelBuilder.Entity("FacilityApp.Data.Models.ResidentProfile", b =>
                {
                    ...
                    b.HasOne("FacilityApp.Data.Models.ApplicationUser", "User")
                        ...
                        .HasForeignKey("FacilityApp.Data.Models.ResidentProfile", "UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("FacilityApp.Data.Models.RolePermission", b =>
                {
                    b.HasOne("FacilityApp.Data.Models.AppRole", "AppRole")
            ...
            modelBuilder.Entity("FacilityApp.Data.Models.Unit", b =>
                {
                    ...
                    b.HasOne("FacilityApp.Data.Models.UnitType", "UnitType")
                        .WithMany("Units")
            ...
            modelBuilder.Entity("FacilityApp.Data.Models.Meter", b =>
                {
                    ...
                    b.Navigation("PrepaidTokens");

                    b.Navigation("Readings");

                    b.Navigation("ReplacedByMeter");
                });
